...
module.exports = {
  ...
  cryptoProvider: {
    adjustTvwap: {
      symbols:
        process.env.CRYPTO_PROVIDER_ADJUST_TVWAP_SYMBOLS.split(",") || [],
    },
  ...
  fiatProvider: {
    currencylayer: process.env.FIAT_PROVIDER_CURRENCY_LAYER_INTERVAL && {
      ...
      interval:
        parseInt(process.env.FIAT_PROVIDER_CURRENCY_LAYER_INTERVAL) ||
        60 * 1000,
      timeout:
        parseInt(process.env.FIAT_PROVIDER_CURRENCY_LAYER_TIMEOUT) || 5000,
    ...
    alphavantage: process.env.FIAT_PROVIDER_ALPHA_VANTAGE_INTERVAL && {
      ...
      interval:
        parseInt(process.env.FIAT_PROVIDER_ALPHA_VANTAGE_INTERVAL) || 60 * 1000,
      timeout:
        parseInt(process.env.FIAT_PROVIDER_ALPHA_VANTAGE_TIMEOUT) || 5000,
